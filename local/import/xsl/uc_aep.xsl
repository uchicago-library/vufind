...
<xsl:stylesheet version="1.0"
    ...
    <xsl:param name="collection">American Environmental Photographs</xsl:param>
      ...
      <xsl:if test="contains($URLs, '://') or contains($URLs, 'urn:')">
        ...
        <add>
            <doc>
                ...
                <!-- ID -->
                <field name="id">
                      <xsl:value-of select="substring-after(//dc:identifier/text(), '/dig/aep/')"/>
                </field>
          ...
          <field name="format">Photograph</field>
