                        ...
                        while (iter753.hasNext())
                        {
                                fld753 = (DataField) iter753.next();
                                {
                                        if(fld753.getSubfield('a') != null)
                                        {
                                                ...
                                                if ( str.contains("apple mac os 9") || str.contains("atari 2600") || str.contains("atari jaguar") || str.contains("atari lynx") || str.contains("colecovision") || str.contains("intellivision") || str.contains("magnavox odyssey 2") || str.contains("microsoft xbox") || str.contains("microsoft xbox 360") || str.contains("microsoft xbox one") || str.contains("microsoft xbox series x/") || str.contains("new nintendo 3ds") || str.contains("nintendo 3ds") || str.contains("nintendo 64") || str.contains("nintendo ds") || str.contains("nintendo dsi") ||  str.contains("nintendo entertainment system") || str.contains("nintendo game boy") || str.contains("nintendo game boy advance") || str.contains("nintendo game boy color") ||  str.contains("nintendo gamecube") || str.contains("nintendo switch") || str.contains("nintendo switch 2") || str.contains("nintendo virtual boy") || str.contains("nintendo wii") || str.contains("nintendo wii u") || str.contains("sega cd") || str.contains("sega dreamcast") || str.contains("sega game gear") || str.contains("sega genesis") || str.contains("sega mega drive") ||  str.contains("sega mega drive 32x") || str.contains("sega mega-cd") || str.contains("sega saturn") || str.contains("sega super 32x") || str.contains("sony playstation") || str.contains("sony playstation 2") || str.contains("sony playstation 3") || str.contains("sony playstation 4") || str.contains("sony playstation 5") || str.contains("sony playstation portable") || str.contains("sony playstation vita") || str.contains("super nintendo entertainment system") || str.contains("turbografx-16") )
						{
							result.add("VideoGame");
 						}
                                                if ( str.contains("xbox") || str.contains("wii") || str.contains("playstation") || str.contains("sega") )
                                                {
                                                        result.add("VideoGame");        //$
                                                }
                                        }
