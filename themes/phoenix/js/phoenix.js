...
$(document).ready(function() {
  ...
  $('.template-name-results #searchForm_lookfor, .template-dir-alphabrowse #searchForm_lookfor, .template-dir-record #searchForm_lookfor').after('<i class="input-clear fa fa-times-circle-o"></i>');
