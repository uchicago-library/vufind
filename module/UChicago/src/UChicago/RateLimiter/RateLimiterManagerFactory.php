...
use UChicago\RateLimiter\Storage\CredisStorage;
use UChicago\Service\GetServiceTrait;
...
class RateLimiterManagerFactory implements FactoryInterface
{
    ...
    public function __invoke(
        ...
        if (
            ...
            $turnstile = $container->get(\UChicago\RateLimiter\Turnstile\Turnstile::class);
    ...
    protected function createCache(array $config, string $namespaceSuffix): StorageInterface
    {
        ...
        $cacheManager = $this->getService(\UChicago\Cache\Manager::class);
